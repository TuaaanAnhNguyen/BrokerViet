...
class _BookingScreenState extends State<BookingScreen> {
  ...
  void initState() {
    ...
    _selectedTime = _timeSlots.first; // fixed: was widget.scheduledAt.toString() which doesn't match any slot
  }
  ...
  // fixed: removed async — no async work is done here
  ...
  void _confirmBooking() async {
    ...
    // fixed: _selectedPaymentLabel() is now sync, no await needed
...
''');
    try {
      // fixed: createBooking returns Map, not bool — use try/catch for error handling
      ...
      showDialog(
        ...
        builder: (dialogContext) => AlertDialog(
          ...
          content: Text(
            // fixed: now uses widget.serviceTitle which exists in params
  ...
  Widget build(BuildContext context) {
    ...
    // fixed: removed widget.price (doesn't exist) — derive fee from widget.totalPrice instead
            ...
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.serviceTitle, // fixed: was widget.serviceType
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: isSelected ? primaryColor : outlineVariant.withValues(alpha: 0.5),
                          ),
                        ),
                        child: Column(
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: isFull ? null : () => setState(() => _selectedTime = timeText),
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: isSelected ? primaryColor : outlineVariant.withValues(alpha: 0.7),
                        ),
                      ),
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isSelected
                              ? Colors.white
                              : (isFull ? darkText.withValues(alpha: 0.3) : darkText),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    // fixed: now uses widget.packageName which exists in params
                    _buildBillRow('Phí dịch vụ (${widget.packageName})',
                        formatCurrency(serviceFee), bodyText),
                    const SizedBox(height: 6),
                    _buildBillRow('Phí nền tảng', formatCurrency(platformFee), bodyText),
                    const SizedBox(height: 6),
                    _buildBillRow('Khuyến mãi giảm giá (PROMO10)',
                        '-${formatCurrency(discount)}', primaryColor,
                        isMedium: true),
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Text('Giá thanh toán cuối',
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        'Thanh toán bảo mật',
                        style: TextStyle(fontSize: 12, color: bodyText.withValues(alpha: 0.8)),
                      ),
                    ],
                  ),
                ],
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isSelected ? activeColor : defaultOutline.withValues(alpha: 0.6),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: isSelected ? activeColor : defaultOutline, width: 2),
              ),
              child: isSelected
                  ? Center(
                child: Container(
...
// Helper class to resolve type assignment issues in TextStyle logic
class AppFontWeight {
