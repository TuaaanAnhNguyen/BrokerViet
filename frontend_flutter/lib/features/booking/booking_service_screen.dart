                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                          image: NetworkImage('https://lh3.googleusercontent.com/aida-public/AB6AXuAwN6BAzPJqU5zEDXkeQ4R_YP2zSyDRqvkVWroXAj7OzI6PwYn8sLETf4IO1M6e-CkKLE6ZNVCegqwyt4Ghxmx0BphbcmK-DOkf_ULTwiuLLgLgVU7NTcL9GBAZ90taZ1fpA2OLokUdt-yJaQiaeIhDgmG4rx1YgXEN9FLTmGKVZeidlJ2unJJcFGb8O5W0D88WE-zvPjoivdDDc3kb8HuaUHFnux7IIF7Cj5xBIZOns3Q4grf-nUDiyEJYAH7wqvs3IaKEuxT-65_3'),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(fontSize: 10, color: isSelected ? Colors.white70 : bodyText, fontWeight: FontWeight.w500),
                            ),
                            const SizedBox(height: 2),
                            Text(
                              _dates[index]['day']!,
                              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isSelected ? Colors.white : darkText),
                            ),
                            Text(
                              _dates[index]['weekday']!,
                              style: TextStyle(fontSize: 11, color: isSelected ? Colors.white70 : bodyText),
                            ),
                          ],
                        ),
                      ),
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: isSelected ? Center(child: Container(width: 10, height: 10, decoration: BoxDecoration(shape: BoxShape.circle, color: activeColor))) : null,
            ),
          ],
        ),
      ),
